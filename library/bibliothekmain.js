...
function onBookPressed(b) {
   ...
   var id   = book.author.substr(0,3).concat(book.year);
   var str1 = "<html><head><title>";
   var str2 = " - ";
   var str3 = "</title></head><body><pre>@book{";
   var str4 = ",<br>&nbsp;&nbsp;&nbsp;author    = {";
   var str5 = "},<br>&nbsp;&nbsp;&nbsp;title     = {";
   var str6 = "},<br>&nbsp;&nbsp;&nbsp;year      = {";
   var str7 = "},<br>&nbsp;&nbsp;&nbsp;publisher = {";
   var str8 = "},<br>&nbsp;&nbsp;&nbsp;ISBN      = {";
   var str9 = "},<br>}</pre></body></html>";
   var html = str1.concat(book.author).concat(str2).concat(book.title).concat(str3).concat(id).concat(str4).concat(book.author).concat(str5).concat(book.title).concat(str6).concat(book.year).concat(str7).concat(book.publisher).concat(str8).concat(book.ISBN).concat(str9);
